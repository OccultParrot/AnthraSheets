    ...
    >
      <div className="p-8 flex flex-col items-center justify-center backdrop-blur-md bg-slate-600/10 rounded-2xl">
        ...
        <div className="mt-18 flex flex-row gap-8">
          <button className="p-4 w-fit text-md bg-blurple rounded-2xl hover:bg-dark-blurple transition-colors flex flex-row gap-4 justify-center items-center cursor-pointer select-none">
      ...
      <div className="flex flex-col md:flex-row w-full justify-between fixed bottom-0 items-center">
        <button onClick={changePhoto} className=" flex flex-row gap-4  m-4 text-lg bg-slate-600/20 hover:bg-slate-800/20 transition-colors rounded-2xl p-4 backdrop-blur-md cursor-pointer select-none">
          Switch Background
        </button>
        <div className=" flex flex-row gap-4 w-fit  m-4 text-lg bg-slate-600/20 rounded-2xl p-4 backdrop-blur-md cursor-default select-none">
          <p>
